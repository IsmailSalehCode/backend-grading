...
import com.ismail.grading.exception.EntityNotFoundException;
import com.ismail.grading.exception.ErrorResponse;
import com.ismail.grading.exception.GradeNotFoundException;
import com.ismail.grading.exception.StudentNotEnrolledException;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        String msgError;
        if (ex.getMessage().contains("PUBLIC.UK_R43AF9AP4EDM43MMTQ01ODDJ6_INDEX_4 ON PUBLIC.USERS")) {
